...
class PhysicsTest : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tugatish.setOnClickListener {  var ball = 0
            if (test1.checkedRadioButtonId == R.id.savol1){
                ball+=1
            }
            if (test2.checkedRadioButtonId == R.id.savol9){
                ball+=1
            }
            if (test3.checkedRadioButtonId == R.id.savol11){
                ball+=1
            }
            if (test4.checkedRadioButtonId == R.id.savol18){
                ball+=1
            }
